 ...
 * MQ推送消费者
 * 大部分情况下，建议使用此类消费消息
 * 技术上来说，此推送客户端实际上是基础拉服务的包装。
 * 具体来说，当从Broker提取的消息到达时，它将大致调用注册的回调处理程序来馈送消息。
 * 初始化后，该实例可以视为线程安全的。
 * <p>
...
public class DefaultMQPushConsumer extends ClientConfig implements MQPushConsumer {
    ...
    /**
     * Constructor specifying consumer group, RPC hook, message queue allocating algorithm, enabled msg trace flag
    ...
    /**
     * Constructor specifying namespace, consumer group, RPC hook, message queue allocating algorithm, enabled msg
     * trace flag and customized trace topic name.
     *
     * @param namespace                    Namespace for this MQ Producer instance.
     * @param consumerGroup                Consume queue.
     * @param rpcHook                      RPC hook to execute before each remoting command.
