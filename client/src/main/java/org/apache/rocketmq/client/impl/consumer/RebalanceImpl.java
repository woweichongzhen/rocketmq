...
public abstract class RebalanceImpl {
    ...
    protected final ConcurrentMap<MessageQueue, ProcessQueue> processQueueTable = new ConcurrentHashMap<MessageQueue,
            ProcessQueue>(64);
    ...
    public void unlock(final MessageQueue mq, final boolean oneway) {
        ...
        if (findBrokerResult != null) {
            ...
            try {
                this.mQClientFactory.getMQClientAPIImpl().unlockBatchMQ(findBrokerResult.getBrokerAddr(), requestBody
                        , 1000, oneway);
        ...
        switch (messageModel) {
            ...
            case CLUSTERING: {
                ...
                if (mqSet != null && cidAll != null) {
                    ...
                    if (changed) {
                        log.info(
                                "rebalanced result changed. allocateMessageQueueStrategyName={}, group={}, topic={}, " +
                    ...
                    switch (this.consumeType()) {
                        ...
                        case CONSUME_PASSIVELY:
                            ...
                            if (this.removeUnnecessaryMessageQueue(mq, pq)) {
                                it.remove();
                                changed = true;
                                log.error("[BUG]doRebalance, {}, remove unnecessary mq, {}, because pull is pause, so" +
                                                " try to fixed it",
                                        consumerGroup, mq);
                            }
                            break;
