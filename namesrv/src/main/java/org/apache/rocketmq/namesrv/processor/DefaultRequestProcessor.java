...
public class DefaultRequestProcessor extends AsyncNettyRequestProcessor implements NettyRequestProcessor {
     ...
     * @param request 请求命令
     * @return 返回命令
     * @throws RemotingCommandException 命令处理异常
     */
    public RemotingCommand registerBrokerWithFilterServer(ChannelHandlerContext ctx, RemotingCommand request)
        ...
        // 获取kv中的顺序topic配置
        byte[] jsonValue =
                namesrvController.getKvConfigManager().getKVListByNamespace(NamesrvUtil.NAMESPACE_ORDER_TOPIC_CONFIG);
    ...
    public RemotingCommand registerBroker(ChannelHandlerContext ctx,
        ...
        byte[] jsonValue =
                this.namesrvController.getKvConfigManager().getKVListByNamespace(NamesrvUtil.NAMESPACE_ORDER_TOPIC_CONFIG);
        response.setBody(jsonValue);
        response.setCode(ResponseCode.SUCCESS);
        response.setRemark(null);
        return response;
    ...
    private RemotingCommand wipeWritePermOfBroker(ChannelHandlerContext ctx,
        ...
        int wipeTopicCnt =
                this.namesrvController.getRouteInfoManager().wipeWritePermOfBrokerByLock(requestHeader.getBrokerName());
